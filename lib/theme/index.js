...
var mergeKeys = function mergeKeys(base, override) {
  return Object.keys(override || {}).reduce(function (merged, key) {
    merged[key] = _objectSpread(_objectSpread({}, merged[key]), override[key]);
    return merged;
  }, _objectSpread({}, base));
};

function mergeTheme(_ref) {
  var theme = _ref.theme,
      printMode = _ref.printMode;
  var merged = mergeKeys(_defaultTheme.default, theme);
  return printMode ? mergeKeys(merged, _printTheme.default) : merged;
}