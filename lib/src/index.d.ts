...
export { OrderedList, Quote, Heading, ListItem, UnorderedList, Text, Link, CodeSpan } from './components/typography';
export { Table, TableCell, TableRow, TableHeader, TableBody } from './components/table';
...
export { Markdown, MarkdownSlideSet, MarkdownSlide, MarkdownPreHelper } from './components/markdown/markdown';
...
export type { SpectacleTheme, SpectacleThemeOverrides } from './theme/default-theme';
export { fadeTransition, slideTransition, defaultTransition } from './components/transitions';
